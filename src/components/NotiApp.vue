...
<div class="ocm_pover_wr ocm_noti_w">
			...
			<div class="pop_content">
				<div class="noti_head">
					<span class="noti_title">ការជូនដំណឹងថ្មីៗ</span><span class="noti_clear" @click="markAllAsRead">សម្អាតចេញ</span>
				</div>
